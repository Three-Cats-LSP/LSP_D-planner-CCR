...
check('PDF: body padding-bottom 40px', 'padding-bottom: 40px' in epdf)
...
check('No nested version folders', not any(
    os.path.isdir(d) for d in ['LSP_D-PLANNER_v5.8.5', 'LSP_D-PLANNER_v6.0.0', 'LSP_D-PLANNER_v6.0.1', 'LSP_D-PLANNER_v6.0.2']))
import pathlib
